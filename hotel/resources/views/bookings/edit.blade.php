...
<form method="POST" action={{ route('bookings.update', $booking->id) }}>
    ...
    <div class="m-3">
        ...
        <input type="text" name="customerFirstName" class="form-control" id="customerFirstName" value={{ $booking->customerFirstName }}>
    </div>
    ...
    <div class="m-3">
        ...
        <input type="text" name="customerLastName" class="form-control" id="customerLastName" value={{ $booking->customerLastName }}>
    </div>
    ...
    <div class="m-3">
      ...
      <input type="text" name="customerEmail" class="form-control" id="customerEmail" value={{ $booking->customerEmail }}>
    </div>
    ...
    <div class="m-3">
      ...
      <input type="phone" name="customerPhone" class="form-control" id="customerPhone" value={{ $booking->customerPhone }}>
    </div>
    ...
    <div class="m-3">
        ...
        <input type="text" name="room_id" class="form-control" id="room_id" value={{ $booking->room_id }}>
    </div>
    ...
    <div class="m-3">
      ...
      <input type="date" max="" name="booked_until" class="form-control date" id="booked_until" value={{ $booking->booked_until }}>
    </div>
    ...
    @endif
    <button type="submit" name="send" class="m-3 btn btn-primary">Update</button>
  </form>
@endsection